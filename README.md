# Canoply Next.js Website Replica

**Live Demo**: <https://canoply-replica.vercel.app>

---

This project is a website for "Canoply," built using Next.js. It's designed to serve a collection of static HTML pages through a modern React framework, offering a unique hybrid approach to web development.
...
- **Pre-built Pages**: Includes a variety of pre-designed pages such as a blog, gallery, contact page, and more.
